...
<Steps>
  <Step title="Create an OAuth app in your IdP">
    In your identity provider, create an OIDC / OAuth app. Copy the **Redirect URL** shown at the top of **Settings → SSO Domains** (it matches the host you're signed into — typically `https://my.proprietas.app/api/auth/callback/sso`).
  ...
  <Step title="Sign in">
    Sign out, go to [my.proprietas.app/login](https://my.proprietas.app/login) and enter a work email on the verified domain — you'll be sent to your IdP and back into the app.
  </Step>
</Steps>
